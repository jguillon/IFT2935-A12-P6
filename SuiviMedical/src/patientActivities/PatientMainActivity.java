...
public class PatientMainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dossier.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				Intent dossier = new Intent(view.getContext(),
						PatientFile.class);
		...
		report.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent report = new Intent(view.getContext(),
						PatientSendInfos.class);
		...
		urgence.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				simple.setPositiveButton(
						"Oui, envoyez-moi de l'aide d'urgence.",
				...
				simple.setNegativeButton("Non, j'ai accroché le bouton.",
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int id) {
								dialog.cancel();
	...
	public void alertMeds() {
		...
		simple.setCancelable(false);
		simple.setPositiveButton("Accèder à la page de confirmation",
				new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int id) {
						Intent doc = new Intent(((Dialog) dialog).getContext(),
								PatientMeds.class);
						startActivity(doc);
		...
		simple.setNegativeButton("Me rappeler plus tard",
				new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int id) {
